			...
			<div class="card-header border-0">
				...
				<form action="{{ route('order.index') }}" method="get">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 col-sm-12">
							<div class="form-group">
								<label for="user_id">Reference code</label>
								<input value="{{ old('reference') }}" type="text" name="Reference" id="user_id" autocomplete="off" placeholder="Reference code" class="form-control">
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12">
							<div class="form-group">
