				...
				<div class="row align-items-center justify-content-lg-between">
					<div class="col-lg-6">
						<div class="copyright text-center  text-lg-left  text-muted text-white">
							&copy; 2020 <a href="" class="font-weight-bold ml-1 text-white" target="_blank">Fighter</a>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="copyright text-center  text-lg-right  text-muted text-white fr">
								Design & Developed by <a href="https://github.com/team-mahal" class="font-weight-bold ml-1 text-white" target="_blank">Zakir ahmed</a>
						</div>
					</div>
				</div>
			</footer>
