<template>
    <div class="container mx-auto w-full px-2 lg-px-6">
        ...
        <h1 class="text-center text-2xl lg:text-4xl font-extrabold mt-2 lg:mt-8">Earn money</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-1 lg:mt-5">
            ...
            <div class="p-4 pl-0">
                ...
                class="inline-block mt-4 ml-auto cursor-pointer bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded"
                >
                Read more
                </router-link>
            </div>
