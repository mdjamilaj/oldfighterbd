    ...
    <div class="container mx-auto">
        ...
        <div v-if="check === true">
            <div class="text-center md:my-2">
                <h2 class="text-xl md:text-3xl text-blue-400 font-bold uppercase section-title">Offer Orders</h2>
            </div>
            <div class="div overflow-x-scroll" style="height: 500px;">
                ...
                <tbody class="text-center">
                    <tr v-for="order in orders" :key="order.id" >
                        ...
                        <td class="border border-gray-400 px-4 py-2">{{ order.comment }}</td>
             ...
             <div class="text-center md:my-2">
                <h2 class="text-xl md:text-3xl text-blue-400 font-bold section-title">SHOP ORDERS</h2>
            </div>
            <div class="div overflow-x-scroll" style="height: 500px;">
                <table class="border-collapse border-2 border-gray-500 mx-auto">
                <thead class="bg-gray-300">
