      ...
      >
        <div class="w-full mx-auto">
          ...
          >
            ...
            <h2 class="text-xl md-2xl font-serif font-bold mt-2 lg:mt-4">
              Available Balance
            </h2>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div class="font-bold text-xl">
                  {{ formatPrice(user.earn_wallet) }}
                </div>
              </div>
            </div>
            <h2 class="text-xl md-2xl font-serif font-bold mt-2 lg:mt-4">
              Available Earn Balance
            </h2>
          </div>
        </div>
      </div>
      ...
      <table class="border-collapse border-2 border-gray-500 mx-auto">
        ...
        <tbody class="text-center">
          <tr v-for="transaction in transactions" :key="transaction.id">
            ...
            <td class="border text-left border-gray-400 px-4 py-2">
              {{ transaction.status }}
            </td>
            <td class="border border-gray-400 px-4 py-2">
              {{ formatCompat(transaction.created_at) }}
            </td>
          </tr>
          <tr>
            ...
            <td
              class="border border-gray-400 px-4 py-2 text-left font-bold"
              colspan="4"
            ></td>
          </tr>
        </tbody>
      ...
      <table class="border-collapse border-2 border-gray-500 mx-auto">
        ...
        <tbody class="text-center">
          <tr v-for="withdraw in withdraws" :key="withdraw.id">
            ...
            <td class="border border-gray-400 px-4 py-2">
              {{ formatCompat(withdraw.created_at) }}
            </td>
          </tr>
          <tr>
            <td class="border border-gray-400 px-4 py-2 text-center font-bold">
