	...
	<div class="container mx-auto">
		<div class="flex flex-wrap">
			<div class="md:w-5/12 w-full shadow-lg p-2">
				<div class="px-2 py-4">
					<h3
						class="text-4xl sm:text-1xl md:text-2xl lg:text-4xl text-green-600 font-bold"
					>
						{{ product.name }}
					</h3>
					<h4 class="text-2xl text-green-600 font-bold">
						{{ product.tag_line }}
					</h4>
			...
			<div class="md:w-7/12 w-full px-2 mt-4">
				...
				>
					<div class="flex relative">
						<div
							class="rounded-full h-10 w-10 bg-red-600 flex items-center justify-center text-white text-lg absolute" style="top: -42px;"
						>
							1
						</div>
						<div class="ml-2">
				...
				>
					<div class="flex relative">
						<div
							class="rounded-full h-10 w-10 bg-red-600 flex items-center justify-center text-white text-lg absolute"
							style="top: -42px;"
						>
							2
						</div>
							...
							<div class="measuringWrapper text-gray-900">
								<div>
									<div v-if="check == false" class="flex flex-wrap">
										<p v-on:click="modal = true" class="w-1/2 text-white cursor-pointer text-center bg-pink-500 hover:bg-pink-700 text-white py-2 px-2 rounded mb-0">
											Login First To Confirm Your Order
										</p>
										<div class="w-1/2">
											<router-link :to="{ name: 'register' }" class="text-center block bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded ml-2 w-full" active-class="active">
												{{ $t('register') }}
											</router-link>
										</div>
									</div>
						...
						<div class="mt-8">
							...
							>
								...
								<div class="w-full px-3 mb-6 md:mb-3 mt-2">
									<button
										class="appearance-none block w-full bg-pink-500 hover:bg-pink-700 text-white border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
										:loading="form.busy"
									>
										{{ $t("login") }}
									</button>
									<router-link :to="{ name: 'register' }" class="mt-5 text-center blockbg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded ml-2 w-full" active-class="active">
										{{ $t('register') }}
									</router-link>
								</div>
							...
							<div v-else class="">
								<div class="w-full mb-6 md:mb-3 mt-2">
									<button
										class="appearance-none block w-full bg-pink-500 hover:bg-pink-700 text-white border border-gray-200 rounded py-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
		...
		paymentmethod(){
			if (this.checkedData == "") {
				...
				Swal.fire({
					...
					html: '<p style="color:red;">যদি একটি অর্ডার Panding থাকে তবে আর অর্ডার করা যাবে না</p>',
					reverseButtons: true,
					confirmButtonText: "ok"
				});
			}else {
