<template>
    <div class="container mx-auto">
        ...
        <div class="text-center">
            <h2 class="text-4xl text-purple-700 font-bold">Shop Products</h2>
            ...
            >
                ...
                <div v-if="checkifatcart(product.id)" class="grid grid-cols-3 gap-4 justify-center items-center mx-3">
                    <div class="justify-center items-center text-center">
                        <p class="text-white bg-teal-400 text-white font-normal py-2 px-5 rounded btn" style="border-radius: 28px;">
                            {{ cartArray(product.id).quantity }}
                        </p>
                    </div>
                    <div class="justify-center items-center text-center">
                        <button v-if="cartArray(product.id).quantity > 1" class="rounded-full border-2 border-blue-500 p-2 hover:bg-blue-700 fucos:outline-none" @click="minusQuntity(product)">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-minus fa-w-14 w-6 h-6 text-orange-500"><path fill="currentColor" d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" class=""></path></svg>
                        </button>
                        <button v-else class="rounded-full border-2 border-blue-500 p-2 hover:bg-blue-700  fucos:outline-none" @click.prevent="removeFromCart(product)">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-minus fa-w-14 w-6 h-6 text-orange-500"><path fill="currentColor" d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" class=""></path></svg>
                        </button>
                    </div>
                    <div class="justify-center items-center text-center">
                        <button class="rounded-full border-2 border-pink-500 p-2 hover:bg-pink-500 fucos:outline-none" @click="plusQuntity(product)">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-plus fa-w-14 w-6 h-6 text-pink-500"><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" class=""></path></svg>
                        </button>
                    </div>
                </div>
                <p v-else @click="addToCart(product)" class="flex justify-center mx-3 mb-3 items-center text-white cursor-pointer bg-pink-500 hover:bg-pink-700 text-white font-normal py-2 px-2 rounded">
