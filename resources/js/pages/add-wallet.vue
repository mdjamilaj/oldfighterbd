<template>
    <div class="container mx-auto w-full md:w-6/12 xl:w-6/12 p-2 md:p-0">
        <h1 class="text-center text-2xl lg:text-4xl text-teal-500 font-extrabold mt-2 lg:mt-8 mb-2 lg:mb-6">Add Money</h1>
            ...
            <div class="mt-5 border-2 border-gray-600 shadow-xl p-5 text-center">
                <div v-if="paymentMethod == 1">
                    ...
                    <span class="my-3 mt-3" style="font-family: auto;">
                        ...
                        Enter Fighter Personal Account Number.<br>
                        Enter Your amount<br>
                        Enter Reference Number "PlayZone".<br>
                        Now Enter your PIN.<br><br>
                        <b>Almost Done. Now follow Step 2:</b><br>
                        <span>এখন Amount To Add ফিল্ডয়ে আমাদের নাম্বাররে প্রেরিত টাকার পরিমান লিখুন <br>
                            সর্বশেষ Sender Number ফিল্ডয়ে আপনি যে নাম্বার থেকে টাকা পাঠিয়েছেন সেটা লিখে Add Wallet বাটনে Click করুন 
                        </span>
                        <h6 class="text-red-500">৩০ মিনিটের মধ্যে আপনার ওয়ালেটে টাকা Add হয়ে যাবে</h6>
                    </span>
                </div>
                ...
                <div class="">
                    ...
                    <input type="number" v-model="paymentNumber" required placeholder="Sender Number" class="p-2 class-manual-width bg-white hover:bg-gray-100 hover:border-gray-300 border-lg border-gray-500 border-2 focus:outline-none focus:bg-white focus:shadow-outline focus:border-gray-300" />
