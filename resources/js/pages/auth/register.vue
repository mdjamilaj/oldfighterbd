		...
		<form @submit.prevent="register" @keydown="form.onKeydown($event)">
			...
			<div class="form-group font-bold">
				...
				<div class="col-md-7">
					...
					<has-error class="text-red-600" :form="form" field="name" />
				</div>
			</div>
			...
			<div class="form-group font-bold hidden">
				...
				<div class="col-md-7">
					...
					<has-error class="text-red-600" :form="form" field="phone" />
				</div>
			</div>
			...
			<div class="form-group font-bold">
				...
				<div class="col-md-7">
					...
					<has-error class="red-500" :form="form" field="password_confirmation" />
				</div>
			</div>
			...
			<div class="form-group font-bold">
				<div class="col-md-7 offset-md-3 d-flex">
					<!-- Submit Button -->
					<button :loading="form.busy" class="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">
						{{ $t('register') }}
					</button>
