<template>
	<div class="navbar-item has-dropdown is-hoverable bg-white borded-2 rounded-t-lg mt-12 py-5">
		
		<div class="flex justify-between text-3xl font-bold bg-pink-500 hover:bg-pink-700 border-b-2 text-white p-2">
			<h2 class="">Cart Items</h2>
			<svg @click="toggleCartIcon()" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="cursor-pointer svg-inline--fa fa-arrow-right fa-w-14 h-8 w-8 text-white mt-1"><path fill="currentColor" d="M190.5 66.9l22.2-22.2c9.4-9.4 24.6-9.4 33.9 0L441 239c9.4 9.4 9.4 24.6 0 33.9L246.6 467.3c-9.4 9.4-24.6 9.4-33.9 0l-22.2-22.2c-9.5-9.5-9.3-25 .4-34.3L311.4 296H24c-13.3 0-24-10.7-24-24v-32c0-13.3 10.7-24 24-24h287.4L190.9 101.2c-9.8-9.3-10-24.8-.4-34.3z" class=""></path></svg>
		</div>
		<!-- {{ cart }} -->
		<div v-if="cart.length > 0" class="navbar-dropdown is-boxed is-right">
			...
			<div class="flex p-2 mt-2 justify-center items-center">
						<router-link  :to="'/check-out'" class="text-white text-center bg-pink-500 hover:bg-pink-700 text-white font-bold py-1 px-2 rounded w-40">Check Out</router-link>
		...
		<div v-else class="navbar-dropdown is-boxed is-right px-2 ml-8">
