...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        // , 'percentige_orders' => $percentige_orders
        $percentige = $today_users*100/$total_users;
        // $percentige_orders = $today_orders*100/$total_orders;
        return view('admin.index')->with(['total_users' => $total_users, 'total_orders' => $total_orders,'percentige' => $percentige , 'today_users' => $today_users, 'totalwallet' => $totalwallet ,'totalearnwallet' => $totalearnwallet , 'today_orders' => $today_orders]);
    }
